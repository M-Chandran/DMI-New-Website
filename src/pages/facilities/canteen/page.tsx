      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-teal-50">
        ...
        <div className="relative bg-gradient-to-r from-teal-600 to-emerald-600 text-white py-24">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-5xl font-bold mb-4">{facility?.name || 'Canteen'}</h1>
              <p className="text-xl text-teal-100 max-w-3xl mx-auto">
                Delicious and nutritious meals for the campus community
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About Our Canteen</h2>
            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
              {facility?.description ? (
                <p className="whitespace-pre-wrap">{facility.description}</p>
              ) : (
                <p>
                  The DMI Engineering College canteen offers a wide variety of fresh,
                  hygienic, and affordable food options to cater to diverse tastes and
                  dietary preferences. Our spacious dining area provides a comfortable
                  environment for students and staff to relax and enjoy their meals. The
                  canteen maintains high standards of cleanliness and food quality,
